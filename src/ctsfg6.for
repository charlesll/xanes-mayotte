...
*
*
* DISCLAIMER : this is a copy of the CTSFG6 code
* available under the MIT license
* at https://github.com/charlesll/sulfur-magma
...
c	  This will redirect STDOUT to file instead of printing to terminal. 
c	  Comment this out to enable output to terminal.
	  open(unit=IVIDEO, file="stdout.log", form="formatted")
c      write (*,*) ' Do you want to fix fSO2 and fO2 ? (y=1) '
c      write (*,*) 'Option is still in progress; PLEASE TYPE 0'
c      read   (*,*)  kansw
      kansw = 0
...
c     write ISYSPU as comma separated file
      write (ISYSPU,9655) tkelv(I),",",pbar(I),",",xossi(i),",",bossi(i)
     &,",",fS2(i),",",aossi(i),",",Totani(I),",",Totcat(I),",",o1(I)
     &,",",o3(I),",",o(i),",",O(I)/ACIDIC(I)
     &,",",polcos(i),",",Stott(i)*32.064,",",tots(i),",",s2meno(i)
     &,",",so4(i),",",s6stot(i)
     &,",",wec,",",redox(i),",",redoz(i),
     &",",afe2(i),",",petra(i),",",kflag(i)

c      WRITE(ISYSPU, 9655) tkelv(I), pbar(I), xossi(I), 
c     &bossi(I), fS2(I), aossi(I), Totani(I),  
c     &Totcat(I), o1(I), o3(I), o(I), O(I)/ACIDIC(I),  
c     &polcos(I), Stott(I)*32.064, 
c     &tots(I), s2meno(I), so4(I), s6stot(I),  
c     &wec, redox(I), redoz(I), afe2(I),
c     &petra(I), kflag(I)
...
c modified to write comma separated outputs
c9655  format (f8.2,x,f10.3,x,21f12.6,x,i3)
c9655  format (f8.2,a,f10.3,a,
c     &f12.6,a,f12.6,a,f12.6,a,f12.6,a,f12.6,a,f12.6,a,
c     &f12.6,a,f12.6,a,f12.6,a,f12.6,a,f12.6,a,f12.6,a,
c     &f12.6,a,f12.6,a,f12.6,a,f12.6,a,f12.6,a,f12.6,a,
c     &f12.6,a,f12.6,a,f12.6,a,i3)
9655  format (f8.2,a,f10.3,a,21(f12.6,a),i3)
